...
import { NgIterable, OnInit, DoCheck, OnDestroy, Signal, TemplateRef, TrackByFunction, EmbeddedViewRef, Provider } from '@angular/core';
import { RxStrategyNames } from '@rx-angular/cdk/render-strategies';
import { RxDefaultListViewContext, RxListViewComputedContext } from '@rx-angular/cdk/template';
import { Observable, Subject } from 'rxjs';

declare class RxForViewContext<T, U extends NgIterable<T> = NgIterable<T>, K = keyof T> extends RxDefaultListViewContext<T, U, K> {
    rxForOf: U;
 ...
 * @publicApi
 */
declare class RxFor<T, U extends NgIterable<T> = NgIterable<T>> implements OnInit, DoCheck, OnDestroy {
...
declare function provideExperimentalRxForReconciliation(): Provider;

declare function provideLegacyRxForReconciliation(): Provider;
