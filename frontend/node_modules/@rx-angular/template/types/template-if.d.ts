...
import { OnInit, OnChanges, OnDestroy, Signal, TemplateRef, SimpleChanges } from '@angular/core';
import { RxNotificationKind } from '@rx-angular/cdk/notifications';
import { RxStrategyNames } from '@rx-angular/cdk/render-strategies';
import { ObservableInput, Observable, NextObserver } from 'rxjs';
import { rxBaseTemplateNames, RxBaseTemplateNames, RxViewContext } from '@rx-angular/cdk/template';

type rxIfTemplateNames = 'rxThen' | 'rxElse' | rxBaseTemplateNames;
declare const RxIfTemplateNames: {
    readonly then: "rxThen";
    readonly else: "rxElse";
    readonly error: RxBaseTemplateNames.error;
    readonly complete: RxBaseTemplateNames.complete;
    readonly suspense: RxBaseTemplateNames.suspense;
};

interface RxIfViewContext<T = unknown> extends RxViewContext<T> {
    rxIf: T;
    $implicit: T;
}
 ...
 * @publicApi
 */
declare class RxIf<T = unknown> implements OnInit, OnChanges, OnDestroy, OnChanges {
...
export type { RxIfViewContext, rxIfTemplateNames };
