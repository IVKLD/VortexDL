 ...
 * ```
 */
declare function coalesceWith<T>(durationSelector: Observable<unknown>, scope?: Record<string, unknown>): MonoTypeOperatorFunction<T>;
...
declare const coalescingManager: CoalescingManager;

type coalescingObj = object;
interface RxCoalescingOptions {
    scope?: coalescingObj;
}

export { coalesceWith, coalescingManager };
export type { CoalescingManager, RxCoalescingOptions, coalescingObj };
